...
const ICONS: Record<string, React.ReactNode> = {
  ...
  instagram: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#E4405F" strokeWidth="1.8" style={{ flexShrink: 0 }}><rect x="2" y="2" width="20" height="20" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" fill="#E4405F" stroke="none" /></svg>,
